...
public class CustomerLoginExcel extends Base {
	...
	public void i_log_in_my_profile_successfully_error() {
		...
		String actualErrMsg =  getElementText(By.xpath("//span[contains(text(),'দুঃখিত, আপনি ভুল ই-মেইল/ফোন নাম্বার/পাসওয়ার্ড দিয়েছেন!')]"));
